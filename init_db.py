...
engine = create_engine('postgres+psycopg2://postgres:admin1234@127.0.0.1:5432/')
conn = engine.connect()
conn.execute("commit")
...
conn.close()
engine = create_engine('postgres+psycopg2://postgres:admin1234@127.0.0.1:5432/comeunitydb')
metadata = MetaData()
